...
/*Write a method writeChars that accepts an integer parameter n and that prints out n characters as follows.
...
Note that the output does not advance to the next line.*/
